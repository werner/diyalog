...
var _werner$diyalog$ModalCss$zIndex = function (i) {
	return A2(
		_rtfeldman$elm_css$Css$property,
		'z-index',
		_elm_lang$core$Basics$toString(i));
};
var _werner$diyalog$ModalCss$basicCss = _rtfeldman$elm_css$Css$mixin(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$fixed),
		_1: {
			ctor: '::',
			_0: _werner$diyalog$ModalCss$zIndex(1),
			_1: {
				ctor: '::',
...
var _werner$diyalog$ModalCss$CloseCss = {ctor: 'CloseCss'};
var _werner$diyalog$ModalCss$ModalContent = {ctor: 'ModalContent'};
var _werner$diyalog$ModalCss$HideModalCss = {ctor: 'HideModalCss'};
var _werner$diyalog$ModalCss$ShowModalCss = {ctor: 'ShowModalCss'};
var _werner$diyalog$ModalCss$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'modal', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			...
			_werner$diyalog$ModalCss$ShowModalCss,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$block),
				_1: {
					ctor: '::',
					_0: _werner$diyalog$ModalCss$basicCss,
					_1: {ctor: '[]'}
				}
			}),
		_1: {
			...
			_0: A2(
				...
				_werner$diyalog$ModalCss$HideModalCss,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					_werner$diyalog$ModalCss$ModalContent,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							_rtfeldman$elm_css$Css$hex('fefefe')),
						_1: {
							ctor: '::',
							_0: A2(
				...
				_1: {
					...
					_0: A2(
						...
						_werner$diyalog$ModalCss$CloseCss,
						{
							ctor: '::',
...
var _werner$diyalog$Diyalog$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'OkModal') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{visibility: _werner$diyalog$ModalCss$ShowModalCss});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{visibility: _werner$diyalog$ModalCss$HideModalCss});
		}
	});
var _werner$diyalog$Diyalog$_p1 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('modal');
var _werner$diyalog$Diyalog$id = _werner$diyalog$Diyalog$_p1.id;
var _werner$diyalog$Diyalog$class = _werner$diyalog$Diyalog$_p1.$class;
var _werner$diyalog$Diyalog$classList = _werner$diyalog$Diyalog$_p1.classList;
var _werner$diyalog$Diyalog$Model = function (a) {
	return {visibility: a};
};
var _werner$diyalog$Diyalog$HideModal = {ctor: 'HideModal'};
var _werner$diyalog$Diyalog$OkModal = {ctor: 'OkModal'};
var _werner$diyalog$Diyalog$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('myBtn'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_werner$diyalog$Diyalog$OkModal),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Open Modal'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('myModal'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_werner$diyalog$Diyalog$HideModal),
							_1: {
								ctor: '::',
								_0: _werner$diyalog$Diyalog$class(
									{
										ctor: '::',
										_0: model.visibility,
										_1: {ctor: '[]'}
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _werner$diyalog$Diyalog$class(
									{
										ctor: '::',
										_0: _werner$diyalog$ModalCss$ModalContent,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _werner$diyalog$Diyalog$class(
											{
												ctor: '::',
												_0: _werner$diyalog$ModalCss$CloseCss,
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('My Modal'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _werner$diyalog$Diyalog$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: {visibility: _werner$diyalog$ModalCss$HideModalCss},
		view: _werner$diyalog$Diyalog$view,
		update: _werner$diyalog$Diyalog$update
	})();

var Elm = {};
Elm['Diyalog'] = Elm['Diyalog'] || {};
if (typeof _werner$diyalog$Diyalog$main !== 'undefined') {
    _werner$diyalog$Diyalog$main(Elm['Diyalog'], 'Diyalog', undefined);
}
